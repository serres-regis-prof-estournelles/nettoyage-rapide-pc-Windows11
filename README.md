...
✅ Vide le cache ARP
#
✅ Vide le cache NetBIOS (bonus)
#
✅ Renouvelle la configuration IP
#
Le script affiche sa progression et confirme chaque opération. Aucun redémarrage nécessaire !
#
✅ Ce qui est PRÉSERVÉ :
#
✅ Mots de passe enregistrés dans Windows, Chrome, Edge, Firefox, etc...
#
✅ Sessions actives (vous restez connecté partout)
#
✅ Cookies de connexion (pas de déconnexion)
#
...
#
✅ Fichiers personnels (Documents, Images, etc.)
#

🧹 Ce qui est NETTOYÉ :
#
❌ Fichiers temporaires système (fichiers inutiles)
#
❌ Cache DNS (adresses de sites web en mémoire)
#
